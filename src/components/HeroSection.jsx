      ...
      <div className="container-custom">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <h1 className="text-5xl lg:text-6xl font-bold text-dark leading-tight font-thunder">
              <div>Sua Assistente</div>
              <div className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-secondary">
                {currentAdjective}
                <span className="inline-block h-12 bg-primary ml-1 animate-blink" style={{width: '5px'}}></span>
              </div>
              <div>Inteligente</div>
            </h1>
